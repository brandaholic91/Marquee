export const ROLES: Record<string, { label: string; color: string }> = {
  ...
  copywriter:            { label: 'Copywriter',            color: 'bg-primary-soft text-primary-deep' },
  ...
  'brand-voice-guardian':{ label: 'Brand Voice Guardian',  color: 'bg-primary-soft text-primary-deep' },
};
